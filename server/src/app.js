// Application Express réutilisable en local et sur Vercel.
...
app.get("/", (_req, res) => res.json({ name: "FIFA26 / Control API", status: "ok", docs: "/api" }));
app.get("/api", (_req, res) => res.json({
  message: "API REST — Plateforme de gestion de championnat de football",
  status: "ok",
  endpoints: {
    auth: ["POST /api/auth/login", "GET /api/auth/me"],
    groups: ["GET /api/groups"],
    teams: ["GET /api/teams", "GET /api/teams/:id", "POST /api/teams", "PUT /api/teams/:id", "DELETE /api/teams/:id"],
    matches: ["GET /api/matches", "GET /api/matches/:id", "POST /api/matches", "PATCH /api/matches/:id/score", "PUT /api/matches/:id", "DELETE /api/matches/:id"],
    standings: ["GET /api/standings", "GET /api/standings/:group"],
    stats: ["GET /api/stats", "GET /api/stats/top-scorers", "GET /api/stats/discipline", "GET /api/stats/player/:id"],
